 ...
 */
[_COLEMAK] = LAYOUT ( \
  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,       KC_J,    KC_L,    KC_U,    KC_Y,    KC_L, \
  LGUI_T(KC_A),    LALT(KC_R),    LCTL_T(KC_S),    LSFT_T(KC_T),    KC_D,       KC_H,    RSFT_T(KC_N),    RCTL_T(KC_E),    RALT_T(KC_I),    RGUI_T(KC_O), \
